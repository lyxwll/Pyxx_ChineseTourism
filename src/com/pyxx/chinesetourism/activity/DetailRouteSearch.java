 ...
 * @author wll
 */
public class DetailRouteSearch extends BaseActivity implements
	...
	public void nodeClick(View v) {
		...
		// show popup
		popupText = new TextView(DetailRouteSearch.this);
	...
	public void onGetWalkingRouteResult(WalkingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(DetailRouteSearch.this, "抱歉，未找到结果",
