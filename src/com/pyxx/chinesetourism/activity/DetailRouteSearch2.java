 ...
 * @author wll
 */
public class DetailRouteSearch2 extends BaseActivity implements
	...
	protected void onCreate(Bundle bundle) {
		...
		CharSequence titleLable = "路线查询功能";
		setTitle(titleLable);
		// 处理搜索按钮响应
		...
		if (bookBean != null) {
			latitude = bookBean.lat;
			longitude = bookBean.lng;
		}
	...
	private void initMap() {
		...
		MapStatusUpdate u1 = MapStatusUpdateFactory.newLatLng(CENTER);
	...
	public void SearchButtonProcess(View v) {
		...
		String start = editSt.getText().toString().trim();
		String end = editEn.getText().toString().trim();
	...
	public void nodeClick(View v) {
		...
		// show popup
		popupText = new TextView(DetailRouteSearch2.this);
	...
	public void onGetWalkingRouteResult(WalkingRouteResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(DetailRouteSearch2.this, "抱歉，未找到结果",
