 ...
 * @author wll
 */
public class FiveDetailActivity extends BaseActivity implements
		HeaderClickListener {

	HeaderView headerView;
	private InfoBean infoBean;
	private ImageView logoImage;
	TextView title, time, source, content;
	String logo;
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(R.layout.five_detail_layout);
	...
	private void initView() {
		headerView = (HeaderView) findViewById(R.id.five_header);
		headerView.setHeaderClickListener(this);
		headerView.setTitle("国家地理详情");
		headerView.showBack();

		title = (TextView) findViewById(R.id.five_detail_name);
		time = (TextView) findViewById(R.id.five_detail_time);
		source = (TextView) findViewById(R.id.five_comefrom);
		content = (TextView) findViewById(R.id.five_content);
		logoImage = (ImageView) findViewById(R.id.five_detail_img);
		...
		if (infoBean != null) {
			...
			content.setText(infoBean.content);
		}
