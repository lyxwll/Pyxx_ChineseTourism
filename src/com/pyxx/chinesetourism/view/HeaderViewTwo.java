...
public class HeaderViewTwo extends LinearLayout implements OnClickListener{
	...
	public HeaderViewTwo(Context context) {
		this(context, null);
	}
	
	public HeaderViewTwo(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		view = LayoutInflater.from(context).inflate(R.layout.ch_header_layout, this);
